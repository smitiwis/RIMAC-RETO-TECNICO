...
export function PlansPage() {
  ...
  return (
    <div className="pb-4">
      ...
      <div className="w-full border-t border-brand-divider mt-1 mb-3" />
          ...
          <div className="col-span-4 md:col-span-12">
            ...
            {option && (
              <div className="animate-fade-in">
                ...
                {!isLoading && !isError && plans.length > 0 && (
                  <div className="flex flex-col gap-8 w-[calc(100%+2rem)] -mx-4 overflow-hidden md:w-full md:mx-0 md:px-0 md:overflow-visible">
